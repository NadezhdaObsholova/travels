...
},{"./modules/form-validate/form":3,"./modules/start-video":9,"./utils/ios-vh-fix":11}],2:[function(require,module,exports){
"use strict";
...
var startVideo = exports.startVideo = function startVideo() {
  var playBtn = document.querySelector('.hero__media-button');
  if (playBtn) {
    playBtn.addEventListener('click', function () {
      var preview = document.querySelector('.hero__media-preview');
      if (preview) {
        preview.style.display = 'none';
      }
      var videoIframe = document.querySelector('.hero__media-source');

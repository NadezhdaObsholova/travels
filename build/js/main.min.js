...
var _startVideo = require("./modules/start-video");
var _burgerMenu = require("./modules/burger-menu");
var _heroSlider = require("./modules/slider/hero-slider");
var _toursSlider = require("./modules/slider/tours-slider");
var _trainingSlider = require("./modules/slider/training-slider");
var _reviewsSlider = require("./modules/slider/reviews-slider");
var _advSlider = require("./modules/slider/adv-slider");
var _gallerySlider = require("./modules/slider/gallery-slider");
// ---------------------------------
...
},{"./modules/burger-menu":2,"./modules/form-validate/form":4,"./modules/slider/adv-slider":10,"./modules/slider/gallery-slider":11,"./modules/slider/hero-slider":12,"./modules/slider/reviews-slider":13,"./modules/slider/tours-slider":14,"./modules/slider/training-slider":15,"./modules/start-video":16,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
//BURGER-MENU
var burgerMenu = exports.burgerMenu = function burgerMenu() {
  var menuElement = document.querySelector('.main-nav__wrapper');
  var menuButtonElement = document.querySelector('.main-nav__toggle');
  var headerNavElement = document.querySelector('.main-nav__list');
  var menuLogoElement = document.querySelector('.main-nav__logo-link');
  var onClickMenuButtonElement = function onClickMenuButtonElement() {
...
var initAdvSlider = exports.initAdvSlider = function initAdvSlider() {
  ...
  var advSlider = document.querySelector('[data-swiper="adv-slider"]');
  var buttonNext = document.querySelector('[data-button="adv-button-next"]');
  var buttonPrev = document.querySelector('[data-button="adv-button-prev"]');

  // eslint-disable-next-line
  var mySwiper = new Swiper(advSlider, {
    navigation: {
      nextEl: buttonNext,
      prevEl: buttonPrev
    },
...
var initGallerySlider = exports.initGallerySlider = function initGallerySlider() {
  var gallerySlider = document.querySelector('[data-swiper="gallery-slider"]');
  var buttonNext = document.querySelector('[data-button="gallery-button-next"]');
  var buttonPrev = document.querySelector('[data-button="gallery-button-prev"]');
  if (gallerySlider) {
    // eslint-disable-next-line
...
var initHeroSlider = exports.initHeroSlider = function initHeroSlider() {
  var heroSlider = document.querySelector('[data-swiper="hero-slider"]');
  var heroPagination = document.querySelector('[data-pagination="hero-pagination"]');
  if (heroSlider) {
    // eslint-disable-next-line
...
var initReviewsSlider = exports.initReviewsSlider = function initReviewsSlider() {
  var reviewsSlider = document.querySelector('[data-swiper="reviews-slider"]');
...
var initToursSlider = exports.initToursSlider = function initToursSlider() {
  var toursSlider = document.querySelector('[data-swiper="tours-slider"]');
  var buttonNext = document.querySelector('[data-button="tours-button-next"]');
  var buttonPrev = document.querySelector('[data-button="tours-button-prev"]');
  if (toursSlider) {
    // eslint-disable-next-line
...
var initTrainingSlider = exports.initTrainingSlider = function initTrainingSlider() {
  var toursSlider = document.querySelector('[data-swiper="training-slider"]');
  var buttonNext = document.querySelector('[data-button="training-button-next"]');
  var buttonPrev = document.querySelector('[data-button="training-button-prev"]');
  if (toursSlider) {
    // eslint-disable-next-line
    new Swiper(toursSlider, {
      navigation: {
...
var createIframe = function createIframe() {
  var video = document.querySelector('[data-video="hero-video"]');
...
var startVideo = exports.startVideo = function startVideo() {
  var button = document.querySelector('[data-button="video-button"]');
  var preview = document.querySelector('[data-preview="preview"]');
